...
<head>
<title>Elokuvat - Muokkauslomake</title>
...
//Kysely
$query = "SELECT id, enimi, vuosi, nayttelijat, ohjaaja, genre, arvostelu FROM elokuvat WHERE id = '$muutet';";
...
<input type='text' name='enimi' size='80' value='{$rivi['enimi']}' /><br />
Syötä valmistusvuosi: <br />
<input type='text' value='{$rivi['vuosi']}' size='4' maxlength='4' name='vuosi' /><br />
Syötä näyttelijät: <br />
<input type='text' value='{$rivi['nayttelijat']}' size='80' name='nayttelijat' /><br />
Syötä ohjaajan nimi: <br />
<input type='text' value='{$rivi['ohjaaja']}' size='50' name='ohjaaja' /><br />
Syötä genre: <br />
<input type='text' value='{$rivi['genre']}' size='50' name='genre' /><br />
Syötä arviointi: <br />
<input type='text' value='{$rivi['arvostelu']}' size='1' maxlength='1' name='arvostelu' /> / 5<br />
<br />
