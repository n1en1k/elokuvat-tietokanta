...
if (!isset($_SESSION['app5_islogged']) || $_SESSION['app5_islogged'] !== true) { 
   ...
   echo "<ul>
   <li class='current'><a href='index.php'>Etusivu</a></li>
...
<p style="margin:0;">Listauksessa näet kaikki elokuvani, jos sinulla on oikeudet, pystyt lisäämään elokuvia, muokkaamaan elokuvien tietoja ja poistamaan elokuvia listalta. Sivusto toimii SESSION muuttujilla ja elokuvat ovat tallennettu mysql tietokantaan.</p>
</body>
</html>
