...
<head>
<title>Elokuvat - Käyttäjän lisäys</title>
...
$uusikayttajauser   = $_POST['uusiusername'];

$uusikayttajapassword   = $_POST['uusiuserpasswd'];

$uusikayttajapasswordtwo   = $_POST['uusiuserpasswd2'];
...
if($uusikayttajapasswordtwo == "") {
	echo "ET SYÖTTÄNYT SALASANAA!";
    exit();
}

if($uusikayttajapasswordtwo == $uusikayttajapassword) {
	$uusikayttajapass = mysql_real_escape_string($uusikayttajapassword);
...
echo '<a href="listaa.php">Siirry takaisin listaukseen!</a>';
?>
